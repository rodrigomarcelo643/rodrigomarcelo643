<h2 align="left">Hi 👋! I'm Marcelo Rodrigo | Full-Stack & Mobile Developer</h2>

<p align="left">
  🔥 Building scalable web & mobile apps with <strong>MERN Stack</strong>, <strong>React Native</strong>, <strong>Java/Android</strong> & <strong>TypeScript</strong> | PHP/Laravel | Open to collaborations
</p>
...
<img src="https://skillicons.dev/icons?i=ts,js,react,reactnative,nodejs,express,mongodb,java,androidstudio,php,laravel,tailwind,redux,firebase,postman&theme=dark&perline=6" alt="Skill Icons" />
...
<div style="display: flex; gap: 20px; flex-wrap: wrap;">
  <div style="flex: 1; min-width: 300px;">
    ...
    <ul>
      <li>High-performance web & cross-platform mobile apps</li>
      <li>TypeScript-powered clean code</li>
      <li>Native Android (Java) and cross-platform (React Native) solutions</li>
